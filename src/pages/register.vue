      ...
      <CardContent>
        ...
        <form class="grid gap-4" @submit.prevent="signup">
          ...
          <div class="grid gap-2">
            ...
            <Input v-model="formData.password" id="password" type="password" placeholder="*****" autocomplete required />
          </div>

          <div class="grid gap-2">
            <Label v-model="formData.confirmPassword" id="confirm_password" class="text-left">Confirm Password</Label>
            <Input
              id="confirm_password"
              type="password"
              placeholder="*****"
